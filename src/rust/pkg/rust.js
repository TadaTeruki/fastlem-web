...
*/
export function nearest_node_buffer(buffer_width, buffer_height, pixel_scale, nodes) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArrayJsValueToWasm0(nodes, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.nearest_node_buffer(retptr, buffer_width, buffer_height, pixel_scale, ptr0, len0);
...
*/
export function run_terrain_generator(image_width, image_height, node_num, edge_node, nodes) {
    const ptr0 = passArrayJsValueToWasm0(nodes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.run_terrain_generator(image_width, image_height, node_num, edge_node, ptr0, len0);
    return TerrainObject.__wrap(ret);
}
...
export class Node {
    ...
    */
    get erodibility() {
        const ret = wasm.__wbg_get_node_erodibility(this.__wbg_ptr);
        return ret;
    }
    /**
    * @param {number} arg0
    */
    set erodibility(arg0) {
        wasm.__wbg_set_node_erodibility(this.__wbg_ptr, arg0);
    }
    /**
    * @returns {boolean}
    */
    get is_ocean() {
        const ret = wasm.__wbg_get_node_is_ocean(this.__wbg_ptr);
        return ret !== 0;
    }
    /**
    * @param {boolean} arg0
    */
    set is_ocean(arg0) {
        wasm.__wbg_set_node_is_ocean(this.__wbg_ptr, arg0);
    }
}
/**
*/
export class TerrainObject {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(TerrainObject.prototype);
        obj.__wbg_ptr = ptr;
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_terrainobject_free(ptr);
    }
    /**
    * @param {number} x
    * @param {number} y
    ...
    */
    get_altitude(x, y) {
        const ret = wasm.terrainobject_get_altitude(this.__wbg_ptr, x, y);
        return ret;
    }
}
